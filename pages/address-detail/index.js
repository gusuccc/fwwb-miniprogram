...
Page({
    ...
    saveAddress() {
        ...
        if (address.full_region == undefined) {
        ...
        let alladdress=address.full_region+","+address.address;
        let phonenum=address.mobile;
        ...
        //console.log(newdata);
        apin.updateuserinfo(newdata).then(function(res) {
            c
            if (res.ok === true) {
                wx.navigateBack()
            }
    ...
    onShow: function() {
        apin.showuserinfo().then(res=>{
            let info=res.data;
            //console.log(info);
            if(res.msg=="无地址"){console.log("wudizhi!")}
            else if(info.name!=null){
                let address=this.data.address;
              
                address.full_region=info.full_region;
